...
int scull_open(struct inode *inode, struct file *filp)
{
	...
	*/
	...
	printk(KERN_INFO "scull: set open dev finish\n");
	return 0;          /* success */
}
...
void scull_cleanup_module(void)
{
	...
	if (scull_devices) {
		...
		kfree(scull_devices);
         printk(KERN_INFO "scull: clean up dev finish\n");
	}
...
//	[2]
	...
	*/
	...
	printk(KERN_INFO "scull: set up dev finish\n");
}
...
/* [3]在这里初始化设备用了2.6的新方法,在scull_setup_cdev里完成 */
	...
	printk(KERN_INFO "scull: moudle init finish\n");
